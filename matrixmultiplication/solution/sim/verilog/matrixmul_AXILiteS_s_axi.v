...
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    input  wire [9:0]                    A_address0,
    input  wire                          A_ce0,
    output wire [31:0]                   A_q0,
    input  wire [9:0]                    B_address0,
    input  wire                          B_ce0,
...
//------------------------Local signal-------------------
    ...
    reg                           int_A_read;
    reg                           int_A_write;
    wire [9:0]                    int_B_address0;
    wire                          int_B_ce0;
    wire                          int_B_we0;
    wire [3:0]                    int_B_be0;
    wire [31:0]                   int_B_d0;
    wire [31:0]                   int_B_q0;
    wire [9:0]                    int_B_address1;
    wire                          int_B_ce1;
    wire                          int_B_we1;
    wire [3:0]                    int_B_be1;
    wire [31:0]                   int_B_d1;
...
assign int_A_address1  = ar_hs? raddr[11:2] : waddr[11:2];
...
assign int_B_address1  = ar_hs? raddr[11:2] : waddr[11:2];
