...
// ==============================================================
#ifndef __cordic_mul_mul_13bkb__HH__
#define __cordic_mul_mul_13bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordic_mul_mul_13bkb) {
    ...
    SC_CTOR(cordic_mul_mul_13bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
