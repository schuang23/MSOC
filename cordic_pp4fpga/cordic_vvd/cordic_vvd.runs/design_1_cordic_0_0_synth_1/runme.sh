...
HD_PWD='D:/Course/mSOC/cordic_pp4fpga/cordic_vvd/cordic_vvd.runs/design_1_cordic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cordic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cordic_0_0.tcl
