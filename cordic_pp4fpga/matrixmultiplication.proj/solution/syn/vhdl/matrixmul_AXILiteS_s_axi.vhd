...
architecture behave of matrixmul_AXILiteS_s_axi is
    ...
    -- memory signals
    signal int_A_address0      : UNSIGNED(9 downto 0);
    ...
    signal int_A_address1      : UNSIGNED(9 downto 0);
    ...
    signal int_B_address0      : UNSIGNED(9 downto 0);
    ...
    signal int_B_address1      : UNSIGNED(9 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    int_A_address1       <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    ...
    int_B_address1       <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
