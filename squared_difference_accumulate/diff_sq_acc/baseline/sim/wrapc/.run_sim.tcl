...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Vivado/2019.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Vivado/2019.2/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Vivado/2019.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Vivado/2019.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Vivado/2019.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "diff_sq_acc.autotvin.dat"
	set constFileTvOut       "diff_sq_acc.autotvout.dat"
	set constFileHdlTvIn     "diff_sq_acc.autohdltvin.dat"
	set constFileHdlTvOut    "diff_sq_acc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
