...
if {[file isfile diff_sq_acc.autotvin.dat]} {
	file delete -force diff_sq_acc.autotvin.dat
}

if {[file isfile diff_sq_acc.autotvout.dat]} {
	file delete -force diff_sq_acc.autotvout.dat
}
