...
set out_width 32
set exp (i0+i1)*c+i2
set arg_lists {i0 {16 1 +} i1 {16 1 -} s {17 1 +} m {32 1 +} i2 {32 1 +} p {32 1 +} c_expval {a-b} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename a_V \
    op interface \
    ports { a_V_address0 { O 4 vector } a_V_ce0 { O 1 bit } a_V_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename b_V \
    op interface \
    ports { b_V_address0 { O 4 vector } b_V_ce0 { O 1 bit } b_V_q0 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dout_V \
    op interface \
    ports { dout_V { O 48 vector } dout_V_ap_vld { O 1 bit } } \
} "
}
