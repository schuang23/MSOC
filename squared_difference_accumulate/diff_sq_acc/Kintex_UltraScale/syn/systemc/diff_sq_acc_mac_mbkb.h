...
// ==============================================================
#ifndef __diff_sq_acc_mac_mbkb__HH__
#define __diff_sq_acc_mac_mbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(diff_sq_acc_mac_mbkb) {
    ...
    SC_CTOR(diff_sq_acc_mac_mbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
