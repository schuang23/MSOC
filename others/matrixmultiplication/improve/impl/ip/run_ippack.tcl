...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "A {base_address 4096 range 4096} B {base_address 8192 range 4096} AB {base_address 12288 range 4096}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 1033 II x}
