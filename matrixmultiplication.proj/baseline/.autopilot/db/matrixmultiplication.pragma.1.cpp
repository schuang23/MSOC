# 1 "matrixmultiplication.cpp"
# 1 "matrixmultiplication.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "matrixmultiplication.cpp" 2
# 1 "./matrixmultiplication.h" 1
...
# 2 "matrixmultiplication.cpp" 2




void matrixmul(int A[32][32], int B[32][32], int AB[32][32]) {_ssdm_SpecArrayDimSize(A, 32);_ssdm_SpecArrayDimSize(B, 32);_ssdm_SpecArrayDimSize(AB, 32);
_ssdm_op_SpecInterface(A, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 6 "matrixmultiplication.cpp"

_ssdm_op_SpecInterface(AB, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 6 "matrixmultiplication.cpp"
